"""
Django settings for ivcdbn_29 project.
...
WSGI_APPLICATION = 'ivcdbn_29.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ivcdbn_29 API",
    "DESCRIPTION": "API documentation for ivcdbn_29 App",
    "VERSION": "v1",
}
